...
#define LCD_u8D7_GROUP			DIO_u8GROUP_C
#define LCD_u8D7_PIN			    DIO_u8PIN7

#define LCD_u8D6_GROUP			DIO_u8GROUP_C
#define LCD_u8D6_PIN			    DIO_u8PIN6

#define LCD_u8D5_GROUP			DIO_u8GROUP_C
#define LCD_u8D5_PIN			    DIO_u8PIN5

#define LCD_u8D4_GROUP			DIO_u8GROUP_C
#define LCD_u8D4_PIN			    DIO_u8PIN4

#define LCD_u8D3_GROUP			DIO_u8GROUP_C
#define LCD_u8D3_PIN			    DIO_u8PIN0

#define LCD_u8D2_GROUP		    DIO_u8GROUP_D
#define LCD_u8D2_PIN			    DIO_u8PIN3

#define LCD_u8D1_GROUP			DIO_u8GROUP_A
#define LCD_u8D1_PIN			    DIO_u8PIN1

#define LCD_u8D0_GROUP			DIO_u8GROUP_B
#define LCD_u8D0_PIN			    DIO_u8PIN0
